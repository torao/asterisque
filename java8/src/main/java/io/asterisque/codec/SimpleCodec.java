...
public class SimpleCodec implements Codec {
	 ...
	 */
	public static final SimpleCodec Instance = new SimpleCodec();
	 ...
	 */
	public static class SimpleMarshal implements Marshal {
	 ...
	 */
	public static class SimpleUnmarshal implements Unmarshal {
		private final ByteBuffer buffer;
		public SimpleUnmarshal(ByteBuffer buffer){
			buffer.order(ByteOrder.BIG_ENDIAN);
			this.buffer = buffer;
		}
