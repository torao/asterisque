...
// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
/**
 * Sample implementation for declaration-based service. This method is very useful in compatibility
 * to static typing language such as java or scala.
 *
 * @author Takami Torao
 */
object Sample1 {
	...
	/**
	 * All methods in service interface must have `@Export` annotation.
	 */
